    ...
    return (
      <p className="App-depRow">
        ...
        <span className="App-depRow-departure">
          <span className="App-depRow-time">{formatTime(nextDeparture1)}</span>

          <span className={tooLateDeparture1 ? "App-running-late" : ""}>
            {tooLateDeparture1 ? (
        ...
        <span className="App-depRow-departure">
          <span className="App-depRow-time">{formatTime(nextDeparture2)}</span>

          <span className={tooLateDeparture2 ? "App-running-late" : ""}>
            {tooLateDeparture2 ? (
              <img src="running-late.svg" height={14} alt="Sen" />
            ) : null}
      ...
      <main className="App-main">
        ...
        <div className="App-departures">
          ...
          >
            <FullTimeTable
              stop="lumabryggan"
              selectedTime={formatTime(departureTimes.lumabryggan1)}
            />
          </Collapsable>
          ...
          >
            <FullTimeTable
              stop="henriksdal"
              selectedTime={formatTime(departureTimes.henriksdal1)}
            />
          </Collapsable>
        </div>
